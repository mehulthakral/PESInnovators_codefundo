...
class Config():
    training_dir = "C:\\Users\\skand\\OneDrive\\Desktop\\train"
    testing_dir = "C:\\Users\\skand\\OneDrive\\Desktop\\test"
    train_batch_size = 5
...
if __name__ == '__main__':
    ...
    for epoch in range(0, Config.train_number_epochs):
        for i, data in enumerate(train_dataloader, 0):
            ...
            img0, img1, label = Variable(img0), Variable(
                img1), Variable(label)
    ...
    siamese_dataset = SiameseNetworkDataset(imageFolderDataset=folder_dataset_test,transform=transforms.Compose([transforms.Scale((100, 100)),transforms.ToTensor()]), should_invert=False)
    ...
    for i in range(5):
        ...
        euclidean_distance = F.pairwise_distance(output1, output2)
        imshow(torchvision.utils.make_grid(concatenated), 'Dissimilarity: {:.2f}'.format(euclidean_distance.data.numpy()[0]))
    sys.exit(0)